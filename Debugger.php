...
class Debugger
{
    ...
    public static function var_dump( $var,string $title = 'Debugger Reloaded', bool $return = false, int $expandLevel = 1)
    {
        self::$hasArray = false;
        ...
        $html = '
            ...
            'font-family: Menlo,Monaco,Consolas,\'Courier New\',monospace;"><h1>'.$title.'</h1>'.self::renderLegend().'
